		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="订单编号"
							value="${orderDetail.orderNum}" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								...
								value="${orderDetail.orderTimeStr}">
						</div>
					</div>
					<div class="col-md-2 title">路线名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="路线名称"
							value="${orderDetail.product.productName }" readonly="readonly">
					</div>

					<div class="col-md-2 title">出发城市</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出发城市"
							value="${orderDetail.product.cityName }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${orderDetail.product.departureTimeStr}"
								readonly="readonly">
						</div>
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${orderDetail.peopleCount}" readonly="readonly">
					</div>
			...
			<div class="panel panel-default">
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${orderDetail.travellerList}">
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orderDetail.orderStatus==1}">
				<div class="panel panel-default">
